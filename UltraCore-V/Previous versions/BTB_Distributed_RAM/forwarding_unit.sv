// Forwarding Unit - RTL
// Detects RAW data hazards and selects forwarding paths
// from EX/MEM or MEM/WB back to the EX stage operands.
import risc_pkg::*;
...
module forwarding_unit (
  ...
  // 2'b00 = no forwarding (use ID/EX pipeline data)
  ...
  always_comb begin
    if (ex_mem_rf_wr_en && (ex_mem_rd_addr != 5'b0) &&
        (ex_mem_rd_addr == id_ex_rs1_addr))
      fwd_a_sel = 2'b01;  // Forward from EX/MEM (most recent)
    else if (mem_wb_rf_wr_en && (mem_wb_rd_addr != 5'b0) &&
